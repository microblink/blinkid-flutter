...
class BlinkIdSerializationUtils {
  ...
  static func serializeBlinkIdScanningResult(_ scanningResult: BlinkIDScanningResult?) -> String? {
    ...
    if let scanningResult {
      ...
      scanningResultDict["documentClassInfo"] = serializeDocumentClassInfo(
        scanningResult.documentClassInfo)
      ...
      if let additionalNameInformation = scanningResult.additionalNameInformation {
        scanningResultDict["additionalNameInformation"] = serializeStringResult(
      ...
      if let additionalAddressInformation = scanningResult.additionalAddressInformation {
        scanningResultDict["additionalAddressInformation"] = serializeStringResult(
          additionalAddressInformation)
      }
      if let additionalOptionalAddressInformation = scanningResult
        .additionalOptionalAddressInformation
      {
        scanningResultDict["additionalOptionalAddressInformation"] = serializeStringResult(
          additionalOptionalAddressInformation)
      }
      ...
      if let documentAdditionalNumber = scanningResult.documentAdditionalNumber {
        scanningResultDict["documentAdditionalNumber"] = serializeStringResult(
          documentAdditionalNumber)
      }
      if let documentOptionalAdditionalNumber = scanningResult.documentOptionalAdditionalNumber {
        scanningResultDict["documentOptionalAdditionalNumber"] = serializeStringResult(
          documentOptionalAdditionalNumber)
      }
      if let additionalPersonalIdNumber = scanningResult.additionalPersonalIdNumber {
        scanningResultDict["additionalPersonalIdNumber"] = serializeStringResult(
      ...
      if let specificDocumentValidity = scanningResult.specificDocumentValidity {
        scanningResultDict["specificDocumentValidity"] = serializeStringResult(
      ...
      if let nationalInsuranceNumber = scanningResult.nationalInsuranceNumber {
        scanningResultDict["nationalInsuranceNumber"] = serializeStringResult(
      ...
      if let municipalityOfRegistration = scanningResult.municipalityOfRegistration {
        scanningResultDict["municipalityOfRegistration"] = serializeStringResult(
      ...
      if let driverLicenseDetailedInfo = scanningResult.driverLicenseDetailedInfo {
        scanningResultDict["driverLicenseDetailedInfo"] = serializeDriverLicenseDetailedInfo(
  ...
  static func serializeDataMatchState(_ dataMatchState: FieldState) -> [String: Any] {
    return [
  ...
  static func serializeStringResult(_ stringResult: BlinkIDSDK.StringResult?) -> [String: Any?] {
  ...
  static func serializeRect(_ rectangle: BlinkID.RectangleF?) -> [String: Any] {
  ...
  static func serializeDateResult<T>(_ dateResult: DateResult<T>?) -> [String: Any?]? {
    return [
  ...
  static func serializeSimpleDate<T>(_ dateResult: DateResult<T>?) -> [String: Any]? {
  ...
  static func serializeDriverLicenseDetailedInfo<T>(
    _ driverLicenseDetailedInfo: DriverLicenseDetailedInfo<T>?
  ) -> [String: Any?]? {
    return [
      ...
      "vehicleClassesInfo": driverLicenseDetailedInfo?.vehicleClassesInfo?.map(
        serializeVehicleClassInfo(_:)),
    ]
  }

  static func serializeVehicleClassInfo<T>(_ vehicleClassInfo: VehicleClassInfo<T>?) -> [String:
    Any?]
  {
    return [
  ...
  static func serializeDependentInfo(_ dependentInfo: DependentInfo?) -> [String: Any?] {
    return [
  ...
  static func serializeSingleSideScanningResult(
    _ singleSideScanningResult: SingleSideScanningResult?
  ) -> [String: Any?] {
    ...
    return [
      ...
      "signatureImage": serializeDetailedCroppedImageResult(
        singleSideScanningResult.signatureImage),

    ]
  }

  static func serializeBarcodeResult(_ barcodeResult: BarcodeResult?) -> [String: Any?] {
    return [
      ...
      "driverLicenseDetailedInfo": serializeDriverLicenseDetailedInfo(
        barcodeResult?.driverLicenseDetailedInfo),
      "extendedElements": serializeBarcodeExtendedElements(barcodeResult?.extendedElements),
    ]
  }

  static func serializeAddressDetailedInfo(_ addressDetailedInfo: AddressDetailedInfo?) -> [String:
    Any?]
  {
    return [
  ...
  static func serializeBarcodeData(_ barcodeData: BarcodeData?) -> [String: Any?] {
    return [
  ...
  static func serializeBarcodeExtendedElements(_ barcodeExtendedElements: BarcodeElements?)
    -> [String: Any?]
  {
    ...
    return [
      ...
      "jurisdictionEndorsmentCodeDescription": elements?.getValue(
        for: .jurisdictionEndorsmentCodeDescription),
      "jurisdictionRestrictionCodeDescription": elements?.getValue(
        for: .jurisdictionRestrictionCodeDescription),
      ...
      "jurisdictionVehicleClassificationDescription": elements?.getValue(
        for: .jurisdictionVehicleClassificationDescription),
  ...
  static func serializeMrzResult(_ mrzResult: MRZResult?) -> [String: Any?] {
    return [
  ...
  static func serializeVizResult(_ vizResult: VIZResult?) -> [String: Any] {
    var vizResultDict = [String: Any]()
    if let vizResult {
      ...
      if let additionalNameInformation = vizResult.additionalNameInformation {
        vizResultDict["additionalNameInformation"] = serializeStringResult(
          additionalNameInformation)
      }
      ...
      if let additionalAddressInformation = vizResult.additionalAddressInformation {
        vizResultDict["additionalAddressInformation"] = serializeStringResult(
          additionalAddressInformation)
      }
      if let additionalOptionalAddressInformation = vizResult.additionalOptionalAddressInformation {
        vizResultDict["additionalOptionalAddressInformation"] = serializeStringResult(
          additionalOptionalAddressInformation)
      }
      ...
      if let documentOptionalAdditionalNumber = vizResult.documentOptionalAdditionalNumber {
        vizResultDict["documentOptionalAdditionalNumber"] = serializeStringResult(
          documentOptionalAdditionalNumber)
      }
      if let additionalPersonalIdNumber = vizResult.additionalPersonalIdNumber {
        vizResultDict["additionalPersonalIdNumber"] = serializeStringResult(
          additionalPersonalIdNumber)
      }
      ...
      if let driverLicenseDetailedInfo = vizResult.driverLicenseDetailedInfo {
        vizResultDict["driverLicenseDetailedInfo"] = serializeDriverLicenseDetailedInfo(
          driverLicenseDetailedInfo)
      }
      ...
      if let municipalityOfRegistration = vizResult.municipalityOfRegistration {
        vizResultDict["municipalityOfRegistration"] = serializeStringResult(
          municipalityOfRegistration)
      }
  ...
  static func serializeDetailedCroppedImageResult(
    _ detailedcroppedImageResult: DetailedCroppedImageResult?
  ) -> [String: Any?] {
    return [
  ...
  static func serializeParentInfo(_ parentInfo: ParentInfo) -> [String: Any] {
